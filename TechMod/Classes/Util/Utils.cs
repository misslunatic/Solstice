...
public static class Utils
{
    ...
    public static string GetProgressBar(DateTime start, DateTime end, DateTime current, string replaceFill = ":green_square:", string replaceEmpty = ":black_large_square:")
    {
        if (current < start)
        {
            current = start;
        ...
        return progressBar.Replace("X", replaceFill).Replace("-", replaceEmpty);
    }
}
